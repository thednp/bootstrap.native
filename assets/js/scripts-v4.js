...
var popover2 = new BSN.Popover('.popover-via-template', {
	trigger: 'focus',
	template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header">'+someTitleFromOtherCode+'</h3><div class="popover-body">'+someContentFromOuterSpace+'</div></div>'
});
